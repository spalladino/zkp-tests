...
contract TurboVerifier {
    ...
    function get_verification_key() internal pure returns (Types.VerificationKey memory) {
        ...
        assembly {
            ...
            mstore(mload(add(vk, 0xa0)), 0x2a454703f6158c68e2edcda0357b96107c6faf2486abcd1a8371eb6682c687df)//vk.Q1
            mstore(add(mload(add(vk, 0xa0)), 0x20), 0x1c1f58bf6699b57be83453e29460d6ce00f68264a9c1f84e0b784932e385a348)
            mstore(mload(add(vk, 0xc0)), 0x02939149869bd4aa26a430f629ea1b004bc3d6aa4cb3d3e05a9892f08cf37f04)//vk.Q2
            mstore(add(mload(add(vk, 0xc0)), 0x20), 0x1594609fe5be749ec1a5d68468965a8ad82deea3e8e9ba0fa68168f97f690e47)
            mstore(mload(add(vk, 0xe0)), 0x164e50dbb9711733c530320475a6feb9e39eee36e6793f30130424c4d443e96d)//vk.Q3
            mstore(add(mload(add(vk, 0xe0)), 0x20), 0x07b10996710128c0a7aa3cbcb04c3ac7c843ee57a8cbb13c01eee057b7213c1d)
            mstore(mload(add(vk, 0x100)), 0x1f0d45b48aee001185bd19a2640b398dd67c2c12dc4ac463e5eb33854b4f4a6f)//vk.Q4
            mstore(add(mload(add(vk, 0x100)), 0x20), 0x009f88dc6486f21e276db51085dcb6fead4408ee3009ae1774c04c3c054ed052)
            mstore(mload(add(vk, 0x120)), 0x1f0d45b48aee001185bd19a2640b398dd67c2c12dc4ac463e5eb33854b4f4a6f)//vk.Q5
            mstore(add(mload(add(vk, 0x120)), 0x20), 0x009f88dc6486f21e276db51085dcb6fead4408ee3009ae1774c04c3c054ed052)
            mstore(mload(add(vk, 0x140)), 0x19a4685bb81ec6c3c9eb466101c8859af6f459d87357b39850f7d2298545a368)//vk.QM
            mstore(add(mload(add(vk, 0x140)), 0x20), 0x1f6486e13525abc8a45956c2660e9879813e1e821d6c1b62aed9dd6f6553694c)
            mstore(mload(add(vk, 0x160)), 0x1f985b6bbb0e584bea4b7419b160b7708d9950b538c58d4a95aae0ed4f9ac421)//vk.QC
            mstore(add(mload(add(vk, 0x160)), 0x20), 0x0c397d59e41e3705a0d03d0497ac2ae310caf875eb04b8fc4f40c35c2e11a610)
            mstore(mload(add(vk, 0x180)), 0x18577f90440eff82ad4d03b30c85ba170adb0cb2fb19fa946ab55a99b7ff6d32)//vk.QARITH
            mstore(add(mload(add(vk, 0x180)), 0x20), 0x00c59e14ee6c8b851ddc62b7135ac7aac321e3e3e3ae9782475301be7c8a7fe7)
            mstore(mload(add(vk, 0x1a0)), 0x1f0d45b48aee001185bd19a2640b398dd67c2c12dc4ac463e5eb33854b4f4a6f)//vk.QECC
            mstore(add(mload(add(vk, 0x1a0)), 0x20), 0x009f88dc6486f21e276db51085dcb6fead4408ee3009ae1774c04c3c054ed052)
            mstore(mload(add(vk, 0x1c0)), 0x0f65f192803fb2b50a2967e5e0ebc33f819122c0dfc543d51763757974f46da6)//vk.QRANGE
            mstore(add(mload(add(vk, 0x1c0)), 0x20), 0x18fce5965e5b9f7aa64926b819f8bfe4c16222399102ee63658940490e47fad6)
            ...
            mstore(mload(add(vk, 0x200)), 0x20c00bab62dcf4c2e6436a99d2c7262b27dea5d5765fd22f0d13b7663ec05371)//vk.SIGMA1
            mstore(add(mload(add(vk, 0x200)), 0x20), 0x0561f5c0568250a007b05108e81dd57a216da0b166b9c56ebbe76d7158384823)
            mstore(mload(add(vk, 0x220)), 0x06ad56d60a9d7419b23b410870eff4efd71544f0eaeffc3d4e68253b1068ef7f)//vk.SIGMA2
            mstore(add(mload(add(vk, 0x220)), 0x20), 0x01e22d5cb6d43e9ef7fe1be7db7797429a73d4ddea373dffeefd22d0ed706cb0)
            mstore(mload(add(vk, 0x240)), 0x1befe315c460442e5a57707be6a93c7b95915d4b6eb328222ea517aaeaaad66f)//vk.SIGMA3
            mstore(add(mload(add(vk, 0x240)), 0x20), 0x12161f6fe171f22c84c0859f826248a8343920d617aba69bd3ab814dcd02bc95)
            mstore(mload(add(vk, 0x260)), 0x08c77490bd560b36fa845eeb945f2ee15721309f061a395097d7187edb6fb1fb)//vk.SIGMA4
            mstore(add(mload(add(vk, 0x260)), 0x20), 0x1b1930bc47fd4cae095243c481f6d0040db91b925d2ebd26a335273da4b0f6cf)

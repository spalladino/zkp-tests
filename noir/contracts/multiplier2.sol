...
contract TurboVerifier {
    ...
    function get_verification_key() internal pure returns (Types.VerificationKey memory) {
        ...
        assembly {
            ...
            mstore(mload(add(vk, 0xa0)), 0x1149537f26872af568ec4b8d2af9ca863e983761c5906823e4858f3bc678a3db)//vk.Q1
            mstore(add(mload(add(vk, 0xa0)), 0x20), 0x211985185518ae4924a733d3ef7f8be00baeaa8f2ff6636a59703c287198e691)
            mstore(mload(add(vk, 0xc0)), 0x213a49f924b3e46dd9f1829b997ab58daa20bfd58b69383aef909a37029a4666)//vk.Q2
            mstore(add(mload(add(vk, 0xc0)), 0x20), 0x14787973ca88d2df41c566e8279a01dd2fcb585519d8c23212654b22bf9c8b81)
            mstore(mload(add(vk, 0xe0)), 0x1840a11b07033f978489b32d6a945702e2748a46116f196e60806cbc3cd6a8a3)//vk.Q3
            mstore(add(mload(add(vk, 0xe0)), 0x20), 0x0561047ef353e67f1f92439433d1c54e37ecb4cd5c797ff19a5c625652ef6af3)
            ...
            mstore(mload(add(vk, 0x140)), 0x081b51fdf0d6630353cd5960e14aeb0f8204c53c53080afe8855327e0237ea43)//vk.QM
            mstore(add(mload(add(vk, 0x140)), 0x20), 0x134e691ec3ee976dbdb4b4d9f154adc1783bb00865f4283ed7bc4b1da0ffcb9f)
            ...
            mstore(mload(add(vk, 0x200)), 0x164ee90c94f699472394f526d755133206154ddbba63ba3630ce539b59955aaa)//vk.SIGMA1
            mstore(add(mload(add(vk, 0x200)), 0x20), 0x28ab0778795d9ebe0bbc0efb90af2d23b7351d2aa07e52f44b9e896deb668ca9)
            mstore(mload(add(vk, 0x220)), 0x2193e228c489931fac4295a6dc7d40c63e72e835533e392968aab1387afeaf77)//vk.SIGMA2
            mstore(add(mload(add(vk, 0x220)), 0x20), 0x2230f238928ea946681c206f8ba37e17f453f053c4e77c8e541fee422b4a93fc)
            mstore(mload(add(vk, 0x240)), 0x062dd83fb177aab63e622081f4b04e9f3939da5a031b06e32d3121fe5895c36c)//vk.SIGMA3
            mstore(add(mload(add(vk, 0x240)), 0x20), 0x098d4ee5009af9068bf6bc3f2d67c4a5d20e8c653ee3d2fc1e37944611efbe92)
